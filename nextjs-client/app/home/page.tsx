  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center py-2">
      ...
      <main className="flex w-full flex-1 flex-col items-center justify-center px-20 text-center">
        ...
        <div className="mt-6 flex flex-col max-w-4xl items-center justify-around sm:w-full lg:flex-row">
          <Link href="/upload" className="mt-6 w-96 rounded-xl border p-6 text-left hover:text-blue-600 focus:text-blue-600">
          ...
          <Link href="/files" className="mt-6 w-96 rounded-xl border p-6 text-left hover:text-blue-600 focus:text-blue-600">
